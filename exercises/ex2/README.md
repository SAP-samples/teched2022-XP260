...
<br><img src="/exercises/ex2/images/CreateUserGroup.png" width="70%">

3. Create a group with the name "BTP_Admin" and display name "BTP Admin". Click "Create" to save the new group.
<br><img src="/exercises/ex2/images/Create_Group_Dialog.png" width="70%">
...
<br><img src="/exercises/ex2/images/BTP_Cockpit_Application.png" width="70%">
...
<br><img src="/exercises/ex2/images/Applications_Menu_Item.png" width="70%">

3. Choose the tab "Authentication and Access" and click on "Risk-Based Authentication"
<br><img src="/exercises/ex2/images/Overview_Authentication_And_Access.png" width="70%">

4. The list of authentication rules is still empty. Click on "Create Rule"
<br><img src="/exercises/ex2/images/Create_Rule_Button.png" width="70%">
...
<br><img src="/exercises/ex2/images/Create_Rule_Dialog.png" width="70%">

6. When the dialog is closed, click on "Save" to save the newly created authentication rule
<br><img src="/exercises/ex2/images/Save_Rule.png" width="70%">
...
<br><img src="/exercises/ex2/images/IAS_Username_Password.png" width="70%">
...
<br><img src="/exercises/ex2/images/IAS_Register_OTP.png" width="70%">
