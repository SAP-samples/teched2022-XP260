...
9. Go to the "Users" section and enter the email address of the user, with which you are currently logged in to the cockpit. This should be the user of the Default Identity Provider "xp260-0XY@bestrunsap.com". Enter it in the "ID" field and the "Email" field.
